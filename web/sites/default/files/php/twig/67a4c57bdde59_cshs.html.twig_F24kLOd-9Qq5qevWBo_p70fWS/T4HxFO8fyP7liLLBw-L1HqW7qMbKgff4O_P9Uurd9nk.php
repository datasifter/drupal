...
class __TwigTemplate_8129769b3ac22f1a35e3cf7eea217f31 extends Template
{
...
$context["option"], "type", [], "any", false, false, true, 25) == "option")) {
                ...
                yield "\"";
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(((CoreExtension::getAttribute($this->env, $this->source, $context["option"], "selected", [], "any", false, false, true, 26)) ? (" selected=\"selected\"") : ("")));
                yield ">
        ";
                // line 27
...
";
    ...
    {
        return new Source("", "modules/contrib/cshs/templates/cshs.html.twig", "/opt/drupal/web/modules/contrib/cshs/templates/cshs.html.twig");
    }
